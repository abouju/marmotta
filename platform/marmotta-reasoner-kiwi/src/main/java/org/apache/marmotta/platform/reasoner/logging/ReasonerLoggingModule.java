 ...
 */
@ApplicationScoped
public class ReasonerLoggingModule extends BaseLoggingModule {

    public ReasonerLoggingModule() {
    }
    ...
    public Collection<String> getPackages() {
        return ImmutableSet.of(
                "org.apache.marmotta.platform.reasoner",
