 ...
 */
public class GetSRIDFunction2 implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_GEOSPARQL.GETSRID2.toString())) {
            FunctionRegistry.getInstance().add(new GetSRIDFunction2());
        }
    }
    ...
    public String getURI() {
        return FN_GEOSPARQL.GETSRID2.toString();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException("getSRID2 function not supported by dialect " + dialect);
    }
