...
public class FN_GEOSPARQL {
    ...
    public static final URI GETSRID2;
    ...
    static {
        ...
        GETSRID2 = f.createURI(NAMESPACE, "getSRID2");

        RELATE = f.createURI(NAMESPACE, "relate");
        AREA = f.createURI(NAMESPACE, "area");
        ...
        unit = f.createURI(unitsNAMESPACE, "unit");
